Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "Subclassed UITableView/UICollectionView cells that will auto calculate their size so long as AutoLayout constraints are applied correctly. For iOS 7+. Works similar to how iOS 8's auto sizing of cells work"
  s.description  = <<-DESC
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/henrytkirk/HTKDynamicResizingCell.git", :tag => "v0.0.1" }
